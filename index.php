...
<div class="blockFoldHold"><div class="blockFold"></div><div class="blockFoldClear"></div></div>
<div class="blockContent">
<h2>Jak zostać Ambasadorem Jawności?</h2>
...
Obywatelską Watchdog Polska dyspozycje, a w szczególności - informować otoczenie o 
prawie dostępu do informacji oraz wadze jawności w sferze publicznej,</li>
...
Twoje zdjęcie <span style="border-bottom: 1px dotted" title="Poprzez przesłanie zdjęcia wyrażasz zgodę na wykorzystanie wizerunku i przesłanej fotografii przez Sieć Obywatelską Watchdog Polska.">(dodatkowe informacje)</span><br/><input class="textinput textInput form-control" name="photo" type="file" /><br/>
