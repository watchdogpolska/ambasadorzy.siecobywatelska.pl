...
if(isset($_POST['sent'])) {
	...
	if(mysqli_connect_errno()) {
		...
		mysqli_query($link,"CREATE TABLE IF NOT EXISTS `famous` (`idfamous` INT NOT NULL AUTO_INCREMENT, `name` VARCHAR(60) NOT NULL, `www` VARCHAR(60) DEFAULT NULL, `desc` TEXT NOT NULL, `videolink` VARCHAR(90) DEFAULT NULL, PRIMARY KEY (`idfamous`)) ENGINE = InnoDB");
