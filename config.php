...
if(isset($_POST['sent'])) {
	...
	if(mysqli_connect_errno()) {
		...
		mysqli_query($link,"CREATE TABLE IF NOT EXISTS `users` (`idusers` INT NOT NULL AUTO_INCREMENT,`login` VARCHAR(45) NOT NULL,`password` VARCHAR(128) NOT NULL,`name` VARCHAR(60) NOT NULL, `usuniety` TINYINT(1) NOT NULL DEFAULT 0, PRIMARY KEY (`idusers`)) ENGINE = InnoDB;");
