...
while($ambasador = mysqli_fetch_array($waiting, MYSQLI_ASSOC)) {
	...
	echo "<tr><td>$imie</td><td>$nazwisko</td><td>$miasto</td><td>$telefon</td><td>$email</td><td>$dlaczego</td><td>$zawod</td><td>$adres</td><td><img style='max-width: 200px' src='../tmp/$foto' alt=''></td></tr>";
